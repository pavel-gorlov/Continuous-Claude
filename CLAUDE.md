...
- `uv run python -m runtime.harness <script.py>` - Run script w/ MCP
- `uv run python -m runtime.harness <script> --args` - Run script with CLI arguments
...
3. Execute: `uv run python -m runtime.harness scripts/firecrawl_scrape.py --url "..."`
